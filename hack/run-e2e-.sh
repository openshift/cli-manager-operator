...
CLIMANAGER_OPERATOR_ROOT=$(dirname "${BASH_SOURCE}")/..
...
cd CLIMANAGER_OPERATOR_ROOT
/tmp/kubectl create -f deploy/namespace.yaml
/tmp/operator-sdk test local ./test/e2e --up-local --namespace=openshift-cli-manager-operator
