...
CODEGEN_GROUPS_VERSION :=cli-manager:v1alpha1
...
$(call add-crd-gen,cli-manager,./pkg/apis/cli-manager/v1alpha1,./manifests/4.16,./manifests/4.16)
...
generate-clients:
	bash ./vendor/k8s.io/code-generator/generate-groups.sh all github.com/openshift/cli-manager-operator/pkg/generated github.com/openshift/cli-manager-operator/pkg/apis cli-manager:v1alpha1 --go-header-file=./hack/boilerplate.go.txt
