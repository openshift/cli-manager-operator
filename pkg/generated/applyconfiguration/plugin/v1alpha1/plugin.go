...
type PluginApplyConfiguration struct {
	...
	*v1.ObjectMetaApplyConfiguration `json:"metadata,omitempty"`
	...
	Status                           *pluginv1alpha1.PluginStatus  `json:"status,omitempty"`
}
...
func (b *PluginApplyConfiguration) WithStatus(value pluginv1alpha1.PluginStatus) *PluginApplyConfiguration {
	b.Status = &value
	return b
}
