...
// CLIManagerApplyConfiguration represents an declarative configuration of the CLIManager type for use
// with apply.
...
// CLIManager constructs an declarative configuration of the CLIManager type for use with
// apply.
